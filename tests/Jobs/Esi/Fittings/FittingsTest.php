...
namespace Seat\Eveapi\Tests\Jobs\Esi\Fittings;
...
class FittingsTest extends BaseTestCase
{
    public static function setUpBeforeClass(): void
    {
        ...
        $response_success = new EsiResponse(
            file_get_contents(__DIR__ . '/../../../artifacts/fittings/fittings.json'),
            [
    ...
    public function testHandleSuccess()
    {
        ...
        $job = new Fittings($token);
        $job->handle();

        $fittings = CharacterFitting::all();

        $data = json_encode(FittingResource::collection($fittings));
        $this->assertJsonStringEqualsJsonFile(__DIR__ . '/../../../artifacts/fittings/fittings.json', $data);
    }
    ...
    public function testHandleNotModified()
    {
        ...
        CharacterFitting::create([
            'character_id' => 180548812,
            'fitting_id' => 1,
            'name' => 'Random fitting name',
            'description' => 'This is a long as possible description from this fitting explaining nothing and telling a lot of things.',
            'ship_type_id' => 123,
        ]);

        CharacterFittingItem::create([
            'fitting_id' => 1,
            'flag' => 'Cargo',
            'quantity' => 20,
            'type_id' => 1234,
        ...
        foreach ($fittings as $fitting)
            $this->assertEquals($fitting->created_at, $fitting->updated_at);
    ...
    public function testHandleUpdated()
    {
        ...
        EsiInMemoryCache::getInstance()->forget('/v2/characters/180548812/fittings/', 'datasource=tranquility');
        ...
        $data = json_encode(FittingResource::collection($fittings));
        $this->assertCount(2, $fittings);
        $this->assertJsonStringNotEqualsJsonFile(__DIR__ . '/../../../artifacts/fittings/fittings.json', $data);
