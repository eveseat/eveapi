 ...
 */
class LabelsTest extends JobEsiTestCase
{
    public static function setUpBeforeClass(): void
    {
        ...
        $response_success = new EsiResponse(
            file_get_contents(__DIR__ . '/../../../../artifacts/contacts/corporations/labels.json'),
            [
    ...
    public function testHandleSuccess()
    {
        ...
        $job = new Labels(109299958, $token);
        $job->handle();

        $labels = CorporationLabel::all();

        $data = json_encode(ContactLabelResource::collection($labels));
        $this->assertJsonStringEqualsJsonFile(__DIR__ . '/../../../../artifacts/contacts/corporations/labels.json', $data);
    }
    ...
    public function testHandleNotModified()
    {
        ...
        CorporationLabel::create([
            'corporation_id'  => 109299958,
            'label_id'     => 1,
            'name'         => 'Corporation Enemies',
        ]);

        CorporationLabel::create([
            'corporation_id'  => 109299958,
            'label_id'     => 2,
            'name'         => 'Corporation Allies',
        ]);

        CorporationLabel::create([
            'corporation_id'  => 109299958,
            'label_id'     => 3,
            'name'         => 'Corporation Fiends',
        ]);
    ...
    public function testHandleUpdated()
    {
        ...
        EsiInMemoryCache::getInstance()->forget('/v1/corporations/109299958/contacts/labels/', 'datasource=tranquility');
        ...
        $labels = CorporationLabel::all();
        $data = json_encode(ContactLabelResource::collection($labels));
        $this->assertJsonStringNotEqualsJsonFile(__DIR__ . '/../../../../artifacts/contacts/corporations/labels.json', $data);
