...
namespace Seat\Eveapi\Tests\Jobs\Esi\Contacts\Corporation;
...
use Seat\Eveapi\Tests\Resources\Esi\Contacts\Corporations\ContactResource;

/**
 * Class ContactsTest.
 * @package Seat\Eveapi\Tests\Jobs\Esi\Contacts\Corporation
 */
class ContactsTest extends BaseTestCase
{
    public static function setUpBeforeClass(): void
    {
        ...
        $response_success = new EsiResponse(
            file_get_contents(__DIR__ . '/../../../../artifacts/contacts/corporations/contacts.json'),
            [
    ...
    public function testHandleSuccess()
    {
        ...
        $job = new Contacts(109299958, $token);
        $job->handle();

        $contacts = CorporationContact::all();

        $data = json_encode(ContactResource::collection($contacts));
        $this->assertJsonStringEqualsJsonFile(__DIR__ . '/../../../../artifacts/contacts/corporations/contacts.json', $data);
    }
    ...
    public function testHandleUpdated()
    {
        ...
        EsiInMemoryCache::getInstance()->forget('/v2/corporations/109299958/contacts/', 'datasource=tranquility&page=1');
        ...
        $contacts = CorporationContact::all();
        $data = json_encode(ContactResource::collection($contacts));
        $this->assertJsonStringNotEqualsJsonFile(__DIR__ . '/../../../../artifacts/contacts/corporations/contacts.json', $data);
