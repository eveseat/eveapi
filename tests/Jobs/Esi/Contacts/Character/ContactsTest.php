...
use Seat\Eveapi\Tests\Resources\Esi\Contacts\Characters\ContactResource;
...
class ContactsTest extends BaseTestCase
{
    public static function setUpBeforeClass(): void
    {
        ...
        $response_success = new EsiResponse(
            file_get_contents(__DIR__ . '/../../../../artifacts/contacts/characters/contacts.json'),
            [
    ...
    public function testHandleSuccess()
    {
        ...
        $job = new Contacts($token);
        $job->handle();

        $contacts = CharacterContact::all();

        $data = json_encode(ContactResource::collection($contacts));
        $this->assertJsonStringEqualsJsonFile(__DIR__ . '/../../../../artifacts/contacts/characters/contacts.json', $data);
    }
    ...
    public function testHandleUpdated()
    {
        ...
        EsiInMemoryCache::getInstance()->forget('/v2/characters/180548812/contacts/', 'datasource=tranquility&page=1');
        ...
        $contacts = CharacterContact::all();
        $data = json_encode(ContactResource::collection($contacts));
        $this->assertJsonStringNotEqualsJsonFile(__DIR__ . '/../../../../artifacts/contacts/characters/contacts.json', $data);
