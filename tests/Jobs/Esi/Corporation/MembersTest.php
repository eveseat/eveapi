...
class MembersTest extends BaseTestCase
{
    public static function setUpBeforeClass(): void
    {
        ...
        $response_success = new EsiResponse(
            file_get_contents(__DIR__ . '/../../../artifacts/corporation/members.json'),
            [
    ...
    public function testHandleSuccess()
    {
        ...
        $job = new Members(109299958, $token);
        $job->handle();

        $members = CorporationMember::all();

        $data = json_encode($members->pluck('character_id')->toArray());
        $this->assertJsonStringEqualsJsonFile(__DIR__ . '/../../../artifacts/corporation/members.json', $data);
    }
    ...
    public function testHandleUpdated()
    {
        ...
        EsiInMemoryCache::getInstance()->forget('/v3/corporations/109299958/members/', 'datasource=tranquility');
        ...
        $members = CorporationMember::all();
        $data = json_encode($members->pluck('character_id')->toArray());
        $this->assertJsonStringNotEqualsJsonFile(__DIR__ . '/../../../artifacts/corporation/members.json', $data);
