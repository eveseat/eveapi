...
class LimitTest extends BaseTestCase
{
    public static function setUpBeforeClass(): void
    {
        ...
        $response_success = new EsiResponse(
            file_get_contents(__DIR__ . '/../../../artifacts/corporation/limit.json'),
            [
    ...
    public function testHandleSuccess()
    {
        ...
        $job = new MembersLimit(109299958, $token);
        $job->handle();

        $corporation = CorporationMemberLimits::first();

        $data = json_encode($corporation->limit);
        $this->assertJsonStringEqualsJsonFile(__DIR__ . '/../../../artifacts/corporation/limit.json', $data);
    }
    ...
    public function testHandleNotModified()
    {
        ...
        CorporationMemberLimits::create([
    ...
    public function testHandleUpdated()
    {
        ...
        EsiInMemoryCache::getInstance()->forget('/v1/corporations/109299958/members/limit/', 'datasource=tranquility');
        ...
        $corporation = CorporationMemberLimits::first();
        $data = json_encode($corporation->limit);
        $this->assertJsonStringNotEqualsJsonFile(__DIR__ . '/../../../artifacts/corporation/limit.json', $data);
