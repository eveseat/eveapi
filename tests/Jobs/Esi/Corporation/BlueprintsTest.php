...
use Seat\Eveapi\Tests\Resources\Esi\Corporation\BlueprintResource;

/**
 * Class BlueprintsTest
 * @package Seat\Eveapi\Tests\Jobs\Esi\Corporation
 */
class BlueprintsTest extends BaseTestCase
{
    public static function setUpBeforeClass(): void
    {
        ...
        $response_success = new EsiResponse(
            file_get_contents(__DIR__ . '/../../../artifacts/corporation/blueprints.json'),
            [
    ...
    public function testHandleSuccess()
    {
        ...
        $job = new Blueprints(109299958, $token);
        $job->handle();

        $blueprints = CorporationBlueprint::all();

        $data = json_encode(BlueprintResource::collection($blueprints));
        $this->assertJsonStringEqualsJsonFile(__DIR__ . '/../../../artifacts/corporation/blueprints.json', $data);
    }
    ...
    public function testHandleUpdated()
    {
        ...
        EsiInMemoryCache::getInstance()->forget('/v2/corporations/109299958/blueprints/', 'datasource=tranquility&page=1');
        ...
        $blueprints = CorporationBlueprint::all();
        $data = json_encode(BlueprintResource::collection($blueprints));
        $this->assertJsonStringNotEqualsJsonFile(__DIR__ . '/../../../artifacts/corporation/blueprints.json', $data);
