...
class MemberTrackingTest extends BaseTestCase
{
    public static function setUpBeforeClass(): void
    {
        ...
        $response_success = new EsiResponse(
            file_get_contents(__DIR__ . '/../../../artifacts/corporation/member_tracking.json'),
            [
    ...
    public function testHandleSuccess()
    {
        ...
        $job = new MemberTracking(109299958, $token);
        $job->handle();

        $members = CorporationMemberTracking::all();

        $data = json_encode(MemberTrackingResource::collection($members));
        $this->assertJsonStringEqualsJsonFile(__DIR__ . '/../../../artifacts/corporation/member_tracking.json', $data);
    }
    ...
    public function testHandleNotModified()
    {
        ...
        CorporationMemberTracking::create([
            ...
            'location_id'    => 2502,
            'logon_date'     => '2017-07-25T10:54:00Z',
            'logoff_date'    => '2018-10-13T11:23:00Z',
            'start_date'     => '2017-07-25T10:54:00Z',
        ]);
    ...
    public function testHandleUpdated()
    {
        ...
        EsiInMemoryCache::getInstance()->forget('/v1/corporations/109299958/membertracking/', 'datasource=tranquility');
        ...
        $members = CorporationMemberTracking::all();
        $data = json_encode(MemberTrackingResource::collection($members->sortBy('character_id')));
        $this->assertJsonStringNotEqualsJsonFile(__DIR__ . '/../../../artifacts/corporation/member_tracking.json', $data);
