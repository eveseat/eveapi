...
use Seat\Eveapi\Tests\Resources\Esi\Corporation\MedalResource;

/**
 * Class MedalsTest.
 * @package Seat\Eveapi\Tests\Jobs\Esi\Corporation
 */
class MedalsTest extends BaseTestCase
{
    public static function setUpBeforeClass(): void
    {
        ...
        $response_success = new EsiResponse(
            file_get_contents(__DIR__ . '/../../../artifacts/corporation/medals.json'),
            [
    ...
    public function testHandleSuccess()
    {
        ...
        $job = new Medals(109299958, $token);
        $job->handle();

        $medals = CorporationMedal::all();

        $data = json_encode(MedalResource::collection($medals));
        $this->assertJsonStringEqualsJsonFile(__DIR__ . '/../../../artifacts/corporation/medals.json', $data);
    }
    ...
    public function testHandleNotModified()
    {
        ...
        CorporationMedal::create([
            'corporation_id' => 109299958,
            'created_at'  => carbon('2017-10-10T14:00:00Z'),
            'creator_id'  => 46578,
        ...
        foreach ($medals as $medal)
            $this->assertEquals($medal->created_at, carbon('2017-10-10T14:00:00Z'));
    }
    ...
    public function testHandleUpdated()
    {
        ...
        EsiInMemoryCache::getInstance()->forget('/v1/corporations/109299958/medals/', 'datasource=tranquility&page=1');
        ...
        $medals = CorporationMedal::all();
        $data = json_encode(MedalResource::collection($medals));
        $this->assertJsonStringNotEqualsJsonFile(__DIR__ . '/../../../artifacts/corporation/medals.json', $data);
