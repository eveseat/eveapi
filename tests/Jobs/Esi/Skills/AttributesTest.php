...
class AttributesTest extends JobEsiTestCase
{
    public static function setUpBeforeClass(): void
    {
        ...
        $response_success = new EsiResponse(
            file_get_contents(__DIR__ . '/../../../artifacts/skills/attributes.json'),
            [
    ...
    public function testHandleSuccess()
    {
        ...
        $job = new Attributes($token);
        $job->handle();

        $attributes = CharacterAttribute::find(180548812);

        $data = json_encode(new AttributeResource($attributes));
        $this->assertJsonStringEqualsJsonFile(__DIR__ . '/../../../artifacts/skills/attributes.json', $data);
    }
    ...
    public function testHandleNotModified()
    {
        ...
        $attributes = new CharacterAttribute([
            ...
            'willpower' => 7,
            'bonus_remaps' => 2,
            'accrued_remap_cooldown_date' => '2015-03-23T11:37:00Z',
            'last_remap_date' => '2015-03-24T10:37:00Z',
        ]);
        $attributes->save();
        ...
        $this->assertEquals($attributes->created_at, $attributes->updated_at);
    }
    ...
    public function testHandleUpdated()
    {
        ...
        EsiInMemoryCache::getInstance()->forget('/v1/characters/180548812/attributes/', 'datasource=tranquility');
        ...
        $data = json_encode(new AttributeResource($attributes));
        $this->assertJsonStringNotEqualsJsonFile(__DIR__ . '/../../../artifacts/skills/attributes.json', $data);
