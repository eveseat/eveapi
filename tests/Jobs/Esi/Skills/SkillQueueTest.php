...
class SkillQueueTest extends JobEsiTestCase
{
    public static function setUpBeforeClass(): void
    {
        ...
        $response_success = new EsiResponse(
            file_get_contents(__DIR__ . '/../../../artifacts/skills/skillqueue.json'),
            [
    ...
    public function testHandleSuccess()
    {
        ...
        $skill_queue = CharacterSkillQueue::all();

        $data = json_encode(SkillQueueResource::collection($skill_queue));
        $this->assertJsonStringEqualsJsonFile(__DIR__ . '/../../../artifacts/skills/skillqueue.json', $data);
    }
    ...
    public function testHandleNotModified()
    {
        ...
        CharacterSkillQueue::create([
            'character_id'      => 180548812,
            'finish_date'       => '2018-07-01T19:37:39Z',
            'finished_level'    => 3,
            'level_end_sp'      => 3254654,
            'level_start_sp'    => 56465,
            'queue_position'    => 0,
            'skill_id'          => 1,
            'start_date'        => '2018-07-01T19:37:39Z',
            'training_start_sp' => 127,
        ]);
        ...
        CharacterSkillQueue::create([
            ...
            'finish_date'       => '2018-07-01T19:37:39Z',
            'finished_level'    => 3,
            'level_end_sp'      => 2112026549,
            'level_start_sp'    => 6974981,
            'queue_position'    => 3,
            'skill_id'          => 2,
            'start_date'        => '2018-07-01T19:37:39Z',
            'training_start_sp' => 68741,
        ]);
        ...
        foreach ($skill_queue as $queue)
            $this->assertEquals($queue->created_at, $queue->updated_at);
    }
    ...
    public function testHandleUpdated()
    {
        ...
        EsiInMemoryCache::getInstance()->forget('/v2/characters/180548812/skillqueue/', 'datasource=tranquility');
        ...
        $skill_queue = CharacterSkillQueue::all();
        $data = json_encode(SkillQueueResource::collection($skill_queue));
        $this->assertJsonStringNotEqualsJsonFile(__DIR__ . '/../../../artifacts/skills/skillqueue.json', $data);
