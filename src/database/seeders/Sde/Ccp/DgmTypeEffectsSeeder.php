...
use Seat\Eveapi\Mapping\Sde\Ccp\DgmTypeEffectMapping;
use Seat\Eveapi\Database\Seeders\Sde\AbstractSdeSeeder;
use Seat\Eveapi\Models\Sde\DgmTypeEffect;

class DgmTypeEffectsSeeder extends AbstractSdeSeeder
{
    ...
    {
        return new DgmTypeeffectMapping();
    }
