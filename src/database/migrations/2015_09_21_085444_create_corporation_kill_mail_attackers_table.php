...
class CreateCorporationKillMailAttackersTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('corporation_kill_mail_attackers', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        Schema::drop('corporation_kill_mail_attackers');
    }
}
