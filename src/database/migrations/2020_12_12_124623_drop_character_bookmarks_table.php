...
class DropCharacterBookmarksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::create('character_bookmarks', function (Blueprint $table) {
            ...
            $table->index('folder_id', 'character_bookmarks_folder_id_index');
            $table->index('creator_id', 'character_bookmarks_creator_id_index');
            $table->index('character_id', 'character_bookmarks_character_id_index');
