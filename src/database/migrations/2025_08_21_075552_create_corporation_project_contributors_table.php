...
class CreateCorporationProjectContributorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('corporation_project_contributors', function (Blueprint $table) {
            ...
            $table->bigInteger('contributed');

            $table->unique(['project_id', 'character_id']);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::drop('corporation_project_contributors');
    }
}
