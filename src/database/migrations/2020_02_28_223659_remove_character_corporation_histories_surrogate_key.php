...
/**
 * Class RemoveCharacterCorporationHistoriesSurrogateKey.
 */
class RemoveCharacterCorporationHistoriesSurrogateKey extends Migration
{
    public function up()
    {
        Schema::table('character_corporation_histories', function (Blueprint $table) {
            $table->dropPrimary(['character_id', 'record_id']);
