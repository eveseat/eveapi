...
/**
 * Class RemoveCharacterAgentResearchesSurrogateKey.
 */
class RemoveCharacterAgentResearchesSurrogateKey extends Migration
{
    public function up()
    {
        Schema::table('character_agent_researches', function (Blueprint $table) {
            $table->dropPrimary(['character_id', 'agent_id']);
