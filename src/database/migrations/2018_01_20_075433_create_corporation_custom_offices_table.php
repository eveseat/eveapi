...
class CreateCorporationCustomOfficesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('corporation_custom_offices', function (Blueprint $table) {
            ...
            $table->primary(['corporation_id', 'office_id'], 'corporation_custom_offices_primary_key');
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('corporation_custom_offices');
    }
}
