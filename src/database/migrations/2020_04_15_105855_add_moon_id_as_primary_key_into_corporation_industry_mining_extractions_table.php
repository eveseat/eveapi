...
/**
 * Class AddMoonIdAsPrimaryKeyIntoCorporationIndustryMiningExtractionsTable.
 */
class AddMoonIdAsPrimaryKeyIntoCorporationIndustryMiningExtractionsTable extends Migration
{
    public function up()
    {
