...
class CreateCharacterWalletJournalExtraInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('character_wallet_journal_extra_infos', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('character_wallet_journal_extra_infos');
    }
}
